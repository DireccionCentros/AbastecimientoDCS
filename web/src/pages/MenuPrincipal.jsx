      ...
      <div style={styles.wrapper}>
        <div style={styles.content}>
          <div style={styles.grid}>
            <Link
              to="/compras"
              onMouseEnter={() => setHovered("compras")}
              onMouseLeave={() => setHovered("")}
              style={{
                ...styles.tileBtn,
                ...(hovered === "compras" ? styles.tileBtnHover : null),
              }}
            >
              <div style={styles.tileLeft}>
                <div style={styles.tileTitle}>Compras</div>
              </div>
            ...
            <Link
              ...
              style={{
                ...styles.tileBtn,
                ...(hovered === "ingresos" ? styles.tileBtnHover : null),
              }}
            >
              <div style={styles.tileLeft}>
                <div style={styles.tileTitle}>Ingresos</div>
              </div>
              <div aria-hidden="true" style={styles.tileIconWrap}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
            ...
            <Link
              to="/envios"
              onMouseEnter={() => setHovered("envios")}
              onMouseLeave={() => setHovered("")}
              style={{
                ...styles.tileBtn,
                ...(hovered === "envios" ? styles.tileBtnHover : null),
              }}
            >
              <div style={styles.tileLeft}>
                <div style={styles.tileTitle}>Envios</div>
              </div>
              <div aria-hidden="true" style={styles.tileIconWrap}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
            ...
            <Link
              ...
              style={{
                ...styles.tileBtn,
                ...(hovered === "stock" ? styles.tileBtnHover : null),
              }}
            >
              <div style={styles.tileLeft}>
                <div style={styles.tileTitle}>Stock</div>
              </div>
              <div aria-hidden="true" style={styles.tileIconWrap}>
                <svg
                  width="34"
            ...
            <Link
              ...
              style={{
                ...styles.tileBtn,
                ...(hovered === "analisis" ? styles.tileBtnHover : null),
              }}
            >
              <div style={styles.tileLeft}>
                <div style={styles.tileTitle}>Analisis</div>
              </div>
              <div aria-hidden="true" style={styles.tileIconWrap}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
            ...
            <Link
              to="/configuracion"
              onMouseEnter={() => setHovered("configuracion")}
              onMouseLeave={() => setHovered("")}
              style={{
                ...styles.tileBtn,
                ...(hovered === "configuracion" ? styles.tileBtnHover : null),
              }}
            >
              <div style={styles.tileLeft}>
                <div style={styles.tileTitle}>Configuracion</div>
              </div>
              <div aria-hidden="true" style={styles.tileIconWrap}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
